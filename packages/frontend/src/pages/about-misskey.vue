	...
	<div style="overflow: clip;">
		<div class="_spacer" style="--MI_SPACER-w: 600px; --MI_SPACER-min: 20px;">
			<div class="_gaps_m znqjceqz">
				...
				<FormSection>
					<template #label>Techniclip</template>
					<div class="_gaps_s">
						<FormLink to="https://github.com/buachigithub/cherrypick" external>
							<template #icon><i class="ti ti-code"></i></template>
							{{ i18n.ts._aboutMisskey.source }}
							<template #suffix>GitHub</template>
						</FormLink>
						<FormLink to="https://discord.gg/cnzTc7bV44" external>
						...
						<FormLink to="https://patreon.com/Buachi" external>
							<template #icon><i class="ti ti-pig-money"></i></template>
							{{ i18n.ts._aboutMisskey.t_donate }}
